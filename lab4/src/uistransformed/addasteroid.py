...
################################################################################
## Form generated from reading UI file 'addasteroid.ui'
##
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(463, 670)
        Dialog.setMinimumSize(QSize(463, 670))
        Dialog.setMaximumSize(QSize(463, 670))
...
"}")
        ...
        self.consoleWindowFrame.setGeometry(QRect(7, 10, 448, 656))
...
"}")
        ...
        self.compositionBox = QComboBox(self.consoleWindowFrame)
        self.compositionBox.setObjectName(u"compositionBox")
        self.compositionBox.setMinimumSize(QSize(178, 0))
        self.compositionBox.setMaximumSize(QSize(178, 16777215))
        self.compositionBox.setStyleSheet(u"QComboBox {\n"
"    background-color: rgb(20, 31, 46);\n"
"    color: #a3cfff;\n"
"    border: 1px solid #3a5a7a;\n"
"    border-radius: 5px;\n"
...
"}")
        ...
        self.horizontalLayout_2.addWidget(self.compositionBox)
...
"}")
        ...
        self.orbitTypeBox = QComboBox(self.consoleWindowFrame)
        self.orbitTypeBox.setObjectName(u"orbitTypeBox")
        self.orbitTypeBox.setMinimumSize(QSize(178, 0))
        self.orbitTypeBox.setMaximumSize(QSize(178, 16777215))
        self.orbitTypeBox.setStyleSheet(u"QComboBox {\n"
"    background-color: rgb(20, 31, 46);\n"
"    color: #a3cfff;\n"
"    border: 1px solid #3a5a7a;\n"
"    border-radius: 5px;\n"
...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.orbitTypeBox)
