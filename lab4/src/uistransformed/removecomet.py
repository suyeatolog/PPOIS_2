...
################################################################################
## Form generated from reading UI file 'removecomet.ui'
##
...
"}")
        ...
        self.removecometlabel = QLabel(self.consoleWindowFrame)
        self.removecometlabel.setObjectName(u"removecometlabel")
        self.removecometlabel.setMaximumSize(QSize(16777215, 40))
        self.removecometlabel.setStyleSheet(u"QLabel{\n"
"	\n"
...
"}")
        ...
        self.verticalLayout.addWidget(self.removecometlabel)

        self.cometsBox = QComboBox(self.consoleWindowFrame)
        self.cometsBox.setObjectName(u"cometsBox")
        self.cometsBox.setMinimumSize(QSize(178, 0))
        self.cometsBox.setMaximumSize(QSize(16777215, 16777215))
        self.cometsBox.setStyleSheet(u"QComboBox {\n"
"    background-color: rgb(20, 31, 46);\n"
"    color: #a3cfff;\n"
...
"}")
        ...
        self.verticalLayout.addWidget(self.cometsBox)
...
"}")
        ...
        self.horizontalLayout.addWidget(self.removeCometBtn)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.removecometlabel.setText(QCoreApplication.translate("Dialog", u"Remove Comet", None))
