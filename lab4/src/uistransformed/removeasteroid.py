...
################################################################################
## Form generated from reading UI file 'removeasteroid.ui'
##
...
"}")
        ...
        self.removeasteroidlabel = QLabel(self.consoleWindowFrame)
        self.removeasteroidlabel.setObjectName(u"removeasteroidlabel")
        self.removeasteroidlabel.setMaximumSize(QSize(16777215, 40))
        self.removeasteroidlabel.setStyleSheet(u"QLabel{\n"
"	\n"
...
"}")
        ...
        self.verticalLayout.addWidget(self.removeasteroidlabel)

        self.asteroidsBox = QComboBox(self.consoleWindowFrame)
        self.asteroidsBox.setObjectName(u"asteroidsBox")
        self.asteroidsBox.setMinimumSize(QSize(178, 0))
        self.asteroidsBox.setMaximumSize(QSize(16777215, 16777215))
        self.asteroidsBox.setStyleSheet(u"QComboBox {\n"
"    background-color: rgb(20, 31, 46);\n"
"    color: #a3cfff;\n"
...
"}")
        ...
        self.verticalLayout.addWidget(self.asteroidsBox)
...
"}")
        ...
        self.horizontalLayout.addWidget(self.removeAsteroidBtn)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.removeasteroidlabel.setText(QCoreApplication.translate("Dialog", u"Remove Asteroid", None))
