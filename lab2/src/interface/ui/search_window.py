...
class Ui_SearchStudent(object):
    def setupUi(self, SearchStudent):
        if not SearchStudent.objectName():
            SearchStudent.setObjectName(u"SearchStudent")
        SearchStudent.resize(1118, 461)
        SearchStudent.setMinimumSize(QSize(1118, 461))
        SearchStudent.setStyleSheet(u"background-color: rgb(214, 214, 216);")
        self.verticalLayout_4 = QVBoxLayout(SearchStudent)
        self.verticalLayout_4.setObjectName(u"verticalLayout_4")
        self.searchLabel = QLabel(SearchStudent)
...
"")
        ...
        self.frame_7 = QFrame(SearchStudent)
...
"}")
        ...
        self.retranslateUi(SearchStudent)

        QMetaObject.connectSlotsByName(SearchStudent)
    # setupUi

    def retranslateUi(self, SearchStudent):
        SearchStudent.setWindowTitle(QCoreApplication.translate("SearchStudent", u"Dialog", None))
        self.searchLabel.setText(QCoreApplication.translate("SearchStudent", u"\u041f\u043e\u0438\u0441\u043a \u0441\u0442\u0443\u0434\u0435\u043d\u0442\u043e\u0432", None))
        self.lastName.setText("")
        self.lastName.setPlaceholderText(QCoreApplication.translate("SearchStudent", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0444\u0430\u043c\u0438\u043b\u0438\u044e...", None))
        self.groupBox.setPlaceholderText(QCoreApplication.translate("SearchStudent", u"\u0413\u0440\u0443\u043f\u043f\u0430...", None))
        self.socialWorkLabel.setText(QCoreApplication.translate("SearchStudent", u"\u041e\u0431\u0449\u0435\u0441\u0442\u0432\u0435\u043d\u043d\u0430\u044f \u0440\u0430\u0431\u043e\u0442\u0430", None))
        self.backBtn.setText(QCoreApplication.translate("SearchStudent", u"\u041d\u0430\u0437\u0430\u0434", None))
        self.searchBtn.setText(QCoreApplication.translate("SearchStudent", u"\u041d\u0430\u0439\u0442\u0438 \u0441\u0442\u0443\u0434\u0435\u043d\u0442\u043e\u0432", None))
        ___qtablewidgetitem = self.searchResultTable.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("SearchStudent", u"\u0424\u0418\u041e \u0441\u0442\u0443\u0434\u0435\u043d\u0442\u0430", None));
        ___qtablewidgetitem1 = self.searchResultTable.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("SearchStudent", u"\u0433\u0440\u0443\u043f\u043f\u0430", None));
        ___qtablewidgetitem2 = self.searchResultTable.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("SearchStudent", u"\u041e\u0431\u0449\u0435\u0441\u0442\u0432\u0435\u043d\u043d\u0430\u044f \u0440\u0430\u0431\u043e\u0442\u0430", None));
        self.paginationSize.setItemText(0, QCoreApplication.translate("SearchStudent", u"5", None))
        self.paginationSize.setItemText(1, QCoreApplication.translate("SearchStudent", u"10", None))
        self.paginationSize.setItemText(2, QCoreApplication.translate("SearchStudent", u"15", None))

        self.firstPageBtn.setText(QCoreApplication.translate("SearchStudent", u"1", None))
        self.previousArrowBtn.setText(QCoreApplication.translate("SearchStudent", u"\u2190", None))
        self.currentPageLabel.setText(QCoreApplication.translate("SearchStudent", u"current_page", None))
        self.nextArrowBtn.setText(QCoreApplication.translate("SearchStudent", u"\u2192", None))
        self.lastPageBtn.setText(QCoreApplication.translate("SearchStudent", u"last", None))
    # retranslateUi
